...
import getUserSummary from "./controllers/activity/get-user-summary";
import getTopUsers from "./controllers/activity/get-top-users";
...
// activity routes
guarded(() => {
  router.get("/user/summary/:id", getUserSummary);
